...
export function applyVehicleFilters(
  ...
  return listings.filter((l) => {
    ...
    if (filters.yearMin && !isNaN(year) && year < parseInt(filters.yearMin, 10)) {
      return false;
    }
    if (filters.yearMax && !isNaN(year) && year > parseInt(filters.yearMax, 10)) {
      return false;
    }
    ...
    if (filters.mileageMax && !isNaN(mileage) && mileage > parseInt(filters.mileageMax, 10)) {
      return false;
    }
