    ...
    >
      ...
      <div className="bg-white border-b border-[#e8e6e3] px-4 py-3 flex items-center gap-3 shrink-0">
        <Link
          ...
          className="p-1.5 hover:bg-[#f0eeeb] transition-colors text-[#999]"
        >
        ...
        <button
          ...
          className="p-1.5 hover:bg-red-50 text-[#bbb] hover:text-red-500 transition-colors shrink-0"
        >
            ...
            <div key={msg.id}>
              {showDate && (
                <div className="flex justify-center my-4">
                  <span className="text-[11px] text-[#bbb] bg-[#f0eeeb] px-3 py-1 rounded-full font-medium">
                    {msgDate}
                  </span>
                </div>
              )}
              ...
              >
                  ...
                  >
                    <div className="relative">
                      <button
                        ...
                        className="p-1 rounded-full bg-[#f0eeeb] hover:bg-[#f0eeeb] text-[#999] transition-colors"
                      >
                ...
                {msg.message_type === "offer" && !isDeleted ? (
                  ...
                  >
                    ...
                    <p className="text-[10px] text-[#bbb] px-4 pb-2">
                  ...
                  <div
                    className={`max-w-[75%] px-4 py-2.5 text-sm leading-relaxed ${
                      isDeleted
                        ? "bg-[#f0eeeb] text-[#bbb] italic border border-[#e8e6e3]"
                        : isMe
                  ...
                  >
                    ...
                    {!isDeleted && (
                      <p
                        className={`text-[10px] mt-1 ${isMe ? "text-indigo-200" : "text-[#bbb]"}`}
                      >
                        {formatTime(msg.created_at)}
                      </p>
                    )}
      ...
      <div className="bg-white border-t border-[#e8e6e3] px-4 py-3 shrink-0">
        <div className="flex items-end gap-2">
          <textarea
            ref={inputRef}
            rows={1}
            className="flex-1 px-4 py-2.5 border border-[#e8e6e3] bg-[#faf9f7] focus:bg-white focus:border-indigo-400 focus:ring-2 focus:ring-[#8E7A6B]/10 outline-none text-sm resize-none max-h-32"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white p-6 w-full max-w-sm shadow-xl">
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                <span className="absolute left-4 top-1/2 -translate-y-1/2 text-[#bbb] font-semibold">
                  €
                </span>
                <input
                  type="number"
                  ...
                  className="w-full pl-8 pr-4 py-3 border border-[#e8e6e3] focus:border-indigo-400 focus:ring-2 focus:ring-[#8E7A6B]/10 outline-none font-semibold text-lg"
                />
              </div>
