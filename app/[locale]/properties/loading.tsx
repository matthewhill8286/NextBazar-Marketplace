...
/* ── Inline trusted agency strip skeleton ──────────────────────────────── */
function TrustedAgenciesStripSkeleton() {
  return (
    <div className="mb-10">
  ...
  return (
    <div className="min-h-screen bg-[#faf9f7]">
      ...
      <div className="max-w-7xl mx-auto px-4 py-10">
        ...
        {/* ── Trusted agencies strip skeleton ──────────────────────── */}
        <TrustedAgenciesStripSkeleton />
...
export { TrustedAgenciesStripSkeleton, ShopCardSkeleton };
