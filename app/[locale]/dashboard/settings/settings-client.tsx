...
import { Loader2, Save, User, Mail, Phone, FileText, MessageCircle } from "lucide-react";
  ...
  async function handleSave() {
    ...
    const { error: updateError } = await supabase
      ...
      .update({
        ...
        telegram_username: formData.telegram_username?.replace(/^@/, "") || null,
      })
      .eq("id", profile.id);
        ...
        <div className="pt-2 border-t border-gray-100">
          ...
          <div className="space-y-4">
            <div>
              <label className="flex items-center gap-1.5 text-sm font-medium text-gray-700 mb-1.5">
                {/* WhatsApp icon */}
                <svg viewBox="0 0 24 24" className="w-3.5 h-3.5 fill-green-500" xmlns="http://www.w3.org/2000/svg">
              ...
              />
              <p className="text-xs text-gray-400 mt-1">
                Include country code (e.g. +357 for Cyprus). Buyers will be able to message you directly on WhatsApp.
              </p>
            </div>
            ...
            <div>
              <label className="flex items-center gap-1.5 text-sm font-medium text-gray-700 mb-1.5">
                {/* Telegram icon */}
                <svg viewBox="0 0 24 24" className="w-3.5 h-3.5 fill-sky-500" xmlns="http://www.w3.org/2000/svg">
              ...
              <p className="text-xs text-gray-400 mt-1">
                Your Telegram @username. Buyers will be able to open a chat with you directly.
              </p>
            </div>
          </div>
        </div>
