...
export default function NewInventoryPage() {
  ...
  const [vehicleAttrs, setVehicleAttrs] =
    useState<VehicleAttributes>(EMPTY_VEHICLE_ATTRS);
    ...
    try {
      ...
      toast.error(
        err instanceof Error
          ? err.message
          : "AI description failed. Try again.",
      );
    }
          ...
          <div className="flex items-center justify-between mb-1.5">
            ...
            <button
              ...
              onClick={() => {
                if (!formData.title) {
                  toast.error(
                    "Add a title first so AI can generate a description.",
                  );
                  return;
                }
                handleAiDescription();
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    updateVehicleAttr("fuel_type", e.target.value)
                  }
                >
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    updateVehicleAttr("transmission", e.target.value)
                  }
                >
                  <option value="">Select</option>
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    updateVehicleAttr("body_type", e.target.value)
                  }
                >
                  <option value="">Select</option>
                  {BODY_TYPES.map((bt) => (
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateVehicleAttr("engine_size", e.target.value)
                  }
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-4 gap-3">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    updateVehicleAttr("drive_type", e.target.value)
                  }
                >
                  <option value="">Select</option>
                  {DRIVE_TYPES.map((dt) => (
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    updateVehicleAttr("service_history", e.target.value)
                  }
                >
                  <option value="">Select</option>
